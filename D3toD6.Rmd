...
##countsD1toD3 <- totalcounts[ ,5:10]
countsD3toD6 <- totalcounts[ ,7:11]

##make matrix
countdata <- as.matrix(countsD3toD6)
...
# Plot dispersions
png("D3toD6_qc-dispersions.png", 1000, 1000, pointsize=20)
...
library(gplots)
png("D1toD3_qc-heatmap-samples.png", w=1000, h=1000, pointsize=20)
...
png("D1toD3_qc-pca.png", 1000, 1000, pointsize=20)
...
write.csv(resFilt2, file="lfc0_D3toD6_diffexpr-results.csv")
...
png("D3toD6_diffexpr-maplot.png", 1500, 1000, pointsize=20)
...
png("D3toD6_diffexpr-volcanoplot.png", 1200, 1000, pointsize=20)
...
png("D3toD6_qc-heatmap-genes.png", w=1000, h=1000, pointsize=20)
pheatmap(assay(rld)[select,], cluster_rows=FALSE, show_rownames=TRUE, cluster_cols=FALSE)
dev.off()
