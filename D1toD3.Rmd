...
countsD1toD3 <- totalcounts[ ,4:9]
##countsD3toD6 <- totalcounts[ ,8:13]

##make matrix
countdata <- as.matrix(countsD1toD3)
...
# Plot dispersions
png("D1toD3_qc-dispersions.png", 1000, 1000, pointsize=20)
...
write.csv(resFilt2, file="lfc0_D1toD3_diffexpr-results.csv")
...
png("D1toD3_diffexpr-maplot.png", 1500, 1000, pointsize=20)
...
png("D1toD3_diffexpr-volcanoplot.png", 1200, 1000, pointsize=20)
...
png("D1toD3_qc-heatmap-genes.png", w=1000, h=1000, pointsize=20)
pheatmap(assay(rld)[select,], cluster_rows=FALSE, show_rownames=TRUE, cluster_cols=FALSE)
dev.off()
